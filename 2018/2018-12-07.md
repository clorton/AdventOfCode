...
Your puzzle answer was ```GKPTSLUXBIJMNCADFOVHEWYQRZ```.
...
With 5 workers and the _60+ second_ step durations described above, _how long will it take to complete all of the steps?_
...
If you still want to see it, you can [get your puzzle input](https://adventofcode.com/2018/day/7/input).